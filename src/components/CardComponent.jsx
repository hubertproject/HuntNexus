  ...
  const posts = [
    {
      ...
      content:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse lectus tortor, dignissim sit amet, ultricies sed",
    },
    {
      title: "Hair Dressing",
  ...
  return (
    <>
      <div className="grid gap-6 lg:grid-cols-4 ">
        {posts.map((items, key) => (
          <div
            className="w-full rounded-lg shadow-lg lg:max-w-sm font-quicksand"
            key={key}
          >
            <img
            ...
            <div className="p-4">
              ...
              <p className="mb-2 leading-normal text-sm mb-4">{items.content}</p>
              <div className="flex justify-center items-center">
                <button className="px-4 py-2 text-sm w-full text-blue-100 bg-blue-500 rounded shadow font-quicksand">
                  Apply
                </button>
              </div>
            </div>

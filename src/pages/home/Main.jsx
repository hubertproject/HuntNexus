    ...
    <div className="">
      <div className="md:mt-[6rem] mt-12 md:pl-24 md:p-0 p-6">
        ...
        <p className="font-quicksand md:text-2xl text-md md:mt-2 mt-4 md:max-w-[600px] max-w-[500px] text-gray-600">
          ...
          <span className="text-primary">WorkSeek</span> to turn their ideas
          into reality.
        </p>
        ...
        <div className="mt-14 md:flex items-center gap-2">
          <div className="relative ">
            <div>
              <label
                htmlFor="location"
                className="absolute top-[-1.5rem] font-quicksand text-white pt-1 pb-1 pl-2 pr-2 rounded-md bg-primary"
              >
                Where?
              </label>
            </div>
          ...
          <button className="bg-primary text-white px-4 py-3 md:mt-6 mt-2 rounded-sm font-quicksand">
            Search
          </button>
        </div>
        ...
        <div className="md:mt-12 mt-8 flex items-center gap-12 md:p-0 p-2">
          <div className="border-r-2 border-gray-300 pr-5">
            <h2 className="font-quicksand text-3xl font-semibold text-gray-700">
              1,586
            </h2>
